        ...
        <div className="h-full max-h-[200px] bg-transparent border-2 border-blue-400 rounded-lg  rounded-r-2xl p-5 max-w-full shadow-[0_4px_30px_rgba(0,0,0,0.5)] text-white backdrop-blur-xl hover:scale-[1.02] transition-all duration-300">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 ">
                    <img
                        src="https://i.pinimg.com/736x/4a/b7/07/4ab707d6b3672fc9d57e3c22ad15afa6.jpg"
                        alt="avatar"
                        className="w-17 h-17 p-1 rounded-full border-2 border-cyan-400 shadow-[0_0_20px_rgba(6,182,212,0.5)] object-cover"
                    />
                    <div>
                        <h2 className="font-semibold text-xl tracking-wide drop-shadow-md">Abhinav Pandey</h2>
                        <p className="text-red-400 font-semibold text-lg drop-shadow-sm">S Rank</p>
                    </div>
                </div>
                <p className="text-lg text-gray-300 font-semibold drop-shadow-sm">
                    Level <span className="text-blue-400 font-extrabold">99</span>
                </p>
            </div>
            ...
            <div className="mt-10">
                ...
                <p className="text-center text-xs text-gray-400 mt-1">120 XP</p>
            </div>
        </div>
    );
};

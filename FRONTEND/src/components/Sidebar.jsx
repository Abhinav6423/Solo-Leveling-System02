    ...
    return (
        <div className="flex flex-col justify-between h-full w-64   shadow-2xl p-2 text-gray-300 font-inter">
            ...
            <div>
                ...
                <div className="flex items-center gap-4 mb-10  rounded-xl  mt-4  shadow-lg">
                    <div className="h-14 w-14 rounded-full border border-cyan-400  flex items-center justify-center text-white text-xl font-bold shadow-[0_0_15px_#00bfff]">
                        <img src="https://i.pinimg.com/736x/4a/b7/07/4ab707d6b3672fc9d57e3c22ad15afa6.jpg" alt="" className="p-1 h-full w-full rounded-full object-cover " />
                    </div>
                    <div>
                        <h2 className="text-white font-semibold text-lg tracking-tight ">Abhinav Pandey</h2>
            ...
            <div className="space-y-4">
                ...
                {/* Logout Button */}
                <button className="flex items-center w-full gap-4 py-3 px-4 rounded-xl text-lg cursor-pointer font-medium transition-all duration-300 border border-transparent hover:border-cyan-700/50 hover:bg-gradient-to-r hover:from-cyan-900/10 hover:to-blue-900/10 hover:text-cyan-300 hover:shadow-[0_0_20px_#00bfff25] group">
